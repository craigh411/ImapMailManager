 ...
 */
class ImapMailManagerEmbeddedImageHelper extends ImapMailManagerTestHelper
{

    function __construct($config)
    {
        parent::__construct(true, 'INBOX', $config);
    }
    /**
     ...
     * @return object
     */
    public function fetchStructure($messageNo = 1)
    {
        return (object)[
            'type'          => 1,
            'encoding'      => 0,
